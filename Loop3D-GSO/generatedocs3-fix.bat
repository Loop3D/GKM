...
%pylode%  -o  ..\docs\ex-timelowerjurassic.html %gsogit%\Examples\GSO-ExampleEpochLowerJurassic.ttl
%pylode%  -o  ..\docs\ex-faults.html %gsogit%\Examples\GSO-ExampleFault2.ttl
%pylode%  -o  ..\docs\faultKannaV4Model.html %gsogit%\Examples\GSO-ExampleFaultKannaV4Model.ttl
...
%pylode%  -o  ..\docs\geologicfeature.html %gsogit%\Modules\GSO-Geologic_Feature.ttl
%pylode%  -o  ..\docs\granularmaterial.html %gsogit%\Modules\GSO-Geologic_Granular_Material.ttl
%pylode%  -o  ..\docs\mineral.html %gsogit%\Modules\GSO-Geologic_Mineral.ttl
%pylode%  -o  ..\docs\geologicprocess.html %gsogit%\Modules\GSO-Geologic_Process.ttl
%pylode%  -o  ..\docs\geologicquality.html %gsogit%\Modules\GSO-Geologic_Quality.ttl
%pylode%  -o  ..\docs\geologicreferencesystem.html %gsogit%\Modules\GSO-Geologic_Reference_System.ttl
%pylode%  -o  ..\docs\geologicrelation.html %gsogit%\Modules\GSO-Geologic_Relation.ttl
%pylode%  -o  ..\docs\rockmaterial.html %gsogit%\Modules\GSO-Geologic_Rock_Material.ttl
%pylode%  -o  ..\docs\rockobject.html %gsogit%\Modules\GSO-Geologic_Rock_Object.ttl
%pylode%  -o  ..\docs\geologicrole.html %gsogit%\Modules\GSO-Geologic_Role.ttl
%pylode%  -o  ..\docs\geologicsetting.html %gsogit%\Modules\GSO-Geologic_Setting.ttl
%pylode%  -o  ..\docs\geologiccontact.html %gsogit%\Modules\GSO-Geologic_Structure_Contact.ttl
%pylode%  -o  ..\docs\geologicfault.html %gsogit%\Modules\GSO-Geologic_Structure_Fault.ttl
%pylode%  -o  ..\docs\geologicfold.html %gsogit%\Modules\GSO-Geologic_Structure_Fold.ttl
%pylode%  -o  ..\docs\geologicfoliation.html %gsogit%\Modules\GSO-Geologic_Structure_Foliation.ttl
%pylode%  -o  ..\docs\geologiclineation.html %gsogit%\Modules\GSO-Geologic_Structure_Lineation.ttl
